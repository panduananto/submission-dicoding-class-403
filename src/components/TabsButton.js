	...
	render() {
		return (
			<span
				...
				} inline-flex cursor-pointer items-center gap-2 px-4 py-2 text-sm font-semibold capitalize focus-visible:rounded-lg focus-visible:border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 dark:focus-visible:ring-blue-600`}
			>
